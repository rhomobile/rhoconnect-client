...
#define SWIG_init    Init_SyncEngine
#define SWIG_name    "SyncEngine"

static VALUE mSyncEngine;
...
_wrap_dosync(int argc, VALUE *argv, VALUE self) {
  ...
  if (argc > 0) {
    ...
    if (!SWIG_IsOK(ecode1)) {
      SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "bool","dosync", 1, argv[0] ));
    } 
    arg1 = (bool)(val1);
  }
  if (argc > 1) {
  ...
  if (argc > 2) {
    ...
    if (!SWIG_IsOK(ecode3)) {
      SWIG_exception_fail(SWIG_ArgError(ecode3), Ruby_Format_TypeError( "", "bool","dosync", 3, argv[2] ));
    } 
    arg3 = (bool)(val3);
  }
  result = (VALUE)dosync(arg1,(char const *)arg2,arg3);
  vresult = result;
...
_wrap_dosync_source(int argc, VALUE *argv, VALUE self) {
  ...
  if (argc > 1) {
    ...
    if (!SWIG_IsOK(ecode2)) {
      SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "bool","dosync_source", 2, argv[1] ));
    } 
    arg2 = (bool)(val2);
  }
  if (argc > 2) {
...
_wrap_dosearch(int argc, VALUE *argv, VALUE self) {
  ...
  res2 = SWIG_AsCharPtrAndSize(argv[1], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char const *","dosearch", 2, argv[1] ));
  }
  arg2 = (char *)(buf2);
  res3 = SWIG_AsCharPtrAndSize(argv[2], &buf3, NULL, &alloc3);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "char const *","dosearch", 3, argv[2] ));
  }
  arg3 = (char *)(buf3);
  ecode4 = SWIG_AsVal_bool(argv[3], &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), Ruby_Format_TypeError( "", "bool","dosearch", 4, argv[3] ));
  } 
  arg4 = (bool)(val4);
  ecode5 = SWIG_AsVal_int(argv[4], &val5);
  if (!SWIG_IsOK(ecode5)) {
    SWIG_exception_fail(SWIG_ArgError(ecode5), Ruby_Format_TypeError( "", "int","dosearch", 5, argv[4] ));
  } 
  arg5 = (int)(val5);
  res6 = SWIG_AsCharPtrAndSize(argv[5], &buf6, NULL, &alloc6);
  if (!SWIG_IsOK(res6)) {
    SWIG_exception_fail(SWIG_ArgError(res6), Ruby_Format_TypeError( "", "char const *","dosearch", 6, argv[5] ));
  }
  arg6 = (char *)(buf6);
  res7 = SWIG_AsCharPtrAndSize(argv[6], &buf7, NULL, &alloc7);
  if (!SWIG_IsOK(res7)) {
    SWIG_exception_fail(SWIG_ArgError(res7), Ruby_Format_TypeError( "", "char const *","dosearch", 7, argv[6] ));
  }
  arg7 = (char *)(buf7);
...
_wrap_login(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "char const *","login", 1, argv[0] ));
  }
  arg1 = (char *)(buf1);
  res2 = SWIG_AsCharPtrAndSize(argv[1], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char const *","login", 2, argv[1] ));
  }
  arg2 = (char *)(buf2);
  res3 = SWIG_AsCharPtrAndSize(argv[2], &buf3, NULL, &alloc3);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "char const *","login", 3, argv[2] ));
  }
  arg3 = (char *)(buf3);
...
_wrap_set_notification(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "int","set_notification", 1, argv[0] ));
  } 
  arg1 = (int)(val1);
  res2 = SWIG_AsCharPtrAndSize(argv[1], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char const *","set_notification", 2, argv[1] ));
  }
  arg2 = (char *)(buf2);
  res3 = SWIG_AsCharPtrAndSize(argv[2], &buf3, NULL, &alloc3);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "char *","set_notification", 3, argv[2] ));
  }
  arg3 = (char *)(buf3);
...
_wrap_clear_notification(int argc, VALUE *argv, VALUE self) {
  ...
  ecode1 = SWIG_AsVal_int(argv[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "int","clear_notification", 1, argv[0] ));
  } 
  arg1 = (int)(val1);
...
SWIGINTERN VALUE
_wrap_set_pollinterval(int argc, VALUE *argv, VALUE self) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  int result;
...
_wrap_set_syncserver(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_AsCharPtrAndSize(argv[0], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "char *","set_syncserver", 1, argv[0] ));
  }
  arg1 = (char *)(buf1);
  set_syncserver(arg1);
  if (alloc1 == SWIG_NEWOBJ) free((char*)buf1);
...
_wrap_get_src_attrs(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_AsCharPtrAndSize(argv[0], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "char const *","get_src_attrs", 1, argv[0] ));
  }
  arg1 = (char *)(buf1);
  ecode2 = SWIG_AsVal_int(argv[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "int","get_src_attrs", 2, argv[1] ));
  } 
  arg2 = (int)(val2);
...
_wrap_set_objectnotify_url(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_AsCharPtrAndSize(argv[0], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "char const *","set_objectnotify_url", 1, argv[0] ));
  }
  arg1 = (char *)(buf1);
...
_wrap_add_objectnotify(int argc, VALUE *argv, VALUE self) {
  ...
  ecode1 = SWIG_AsVal_int(argv[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "int","add_objectnotify", 1, argv[0] ));
  } 
  arg1 = (int)(val1);
  res2 = SWIG_AsCharPtrAndSize(argv[1], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char const *","add_objectnotify", 2, argv[1] ));
  }
  arg2 = (char *)(buf2);
...
_wrap_get_lastsync_objectcount(int argc, VALUE *argv, VALUE self) {
  ...
  ecode1 = SWIG_AsVal_int(argv[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "int","get_lastsync_objectcount", 1, argv[0] ));
  } 
  arg1 = (int)(val1);
...
_wrap_set_pagesize(int argc, VALUE *argv, VALUE self) {
  ...
  ecode1 = SWIG_AsVal_int(argv[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "int","set_pagesize", 1, argv[0] ));
  } 
  arg1 = (int)(val1);
  set_pagesize(arg1);
  return Qnil;
...
_wrap_set_threaded_mode(int argc, VALUE *argv, VALUE self) {
  ...
  ecode1 = SWIG_AsVal_bool(argv[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "bool","set_threaded_mode", 1, argv[0] ));
  } 
  arg1 = (bool)(val1);
...
SWIGINTERN VALUE
_wrap_is_syncing(int argc, VALUE *argv, VALUE self) {
  VALUE result;
  VALUE vresult = Qnil;
...
extern "C"
#endif
SWIGEXPORT void Init_SyncEngine(void) {
  size_t i;
  
  SWIG_InitRuntime();
  mSyncEngine = rb_define_module("SyncEngine");
