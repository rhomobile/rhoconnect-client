...
#
#  Copyright (C) 2012-2016 Symbol Technologies, Inc. All rights reserved.
#
#  This program is free software: you can redistribute it and/or modify
#  it under the terms of the GNU General Public License as published by
#  the Free Software Foundation, either version 3 of the License, or
...
if !defined?(RHO_WP7)
 ...
 #    # FIXME: above condition throws the following:
 #    # *** FAIL: BlobBulkSync_test - load_server_sources should be called only from bulk sync with partition parameter!
 #    # lib/rho/rho.rb:432:in `load_server_sources'
 #    # lib/RhoDatabaseApi.rb:122:in `import'
 #    # lib/rhom/rhom.rb:230:in `database_import'
 #    # apps/app/spec/blob_bulksync_spec.rb:177:in `block (2 levels) in <main>'
 #    # ...
